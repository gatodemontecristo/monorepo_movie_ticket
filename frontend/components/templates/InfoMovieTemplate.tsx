...
export const InfoMovieTemplate = ({ movie }: { movie: Movie }) => {
  return (
    <div className='absolute flex flex-row bottom-0 w-full justify-evenly items-baseline-last text-center px-5 py-8 mb-5 gap-10 text-white z-50'>
      ...
      >
        ...
        <InfoLabel
          ...
          subtext='Popularity'
        />
        <InfoLabel text={movie.overview} className=' hidden md:block' />
      </SecondaryInfo>
    </div>
  );
};
